...
const Auth = () => {
  ...
  return (
    <main className="min-h-screen bg-background flex items-center justify-center relative overflow-auto py-8">
      {/* Scanline overlay */}
      ...
      <div className="w-full max-w-sm mx-4 relative z-10">
        ...
        >
          ...
          <div className="relative my-3">
            ...
            <div className="relative flex justify-center text-[9px]">
              <span className="bg-card px-2 text-muted-foreground font-mono uppercase">local</span>
            </div>
          </div>
          ...
          <button
            type="button"
            onClick={() => {
              localStorage.setItem("echo_local_user", "true");
              window.location.href = "/";
            }}
            className="w-full py-2.5 rounded border border-terminal-amber/50 bg-terminal-amber/5 text-terminal-amber hover:bg-terminal-amber/10 transition-colors text-sm font-mono flex items-center justify-center gap-2"
          >
