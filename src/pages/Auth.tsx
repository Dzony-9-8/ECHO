    ...
    <main className="min-h-screen bg-background flex items-center justify-center relative overflow-auto py-8">
      ...
      <div className="w-full max-w-sm mx-4 relative z-10">
        ...
        <button
          ...
          className="w-full mt-3 py-2.5 rounded border border-yellow-500/50 bg-yellow-500/5 text-yellow-400 hover:bg-yellow-500/10 transition-colors text-sm font-mono flex items-center justify-center gap-2"
        >
